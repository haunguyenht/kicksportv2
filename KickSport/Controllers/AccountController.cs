...
using KickSport.Web.Models.Account.ViewModels;
...
namespace KickSport.Controllers
{
    [AllowAnonymous]
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<object> FacebookLogin([FromBody] FacebookLoginInputModel model)
        {
            ...
            if (user is null)
            {
                user = _mapper.Map<ApplicationUser>(userInfo);
                ...
                Subject = new ClaimsIdentity(new Claim[]
                    {
                        ...
                        new Claim(ClaimTypes.Role,
                            _userManager.IsInRoleAsync(user, "Administrator")
                                .GetAwaiter()
